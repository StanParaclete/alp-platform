...
function DownloadModal({onClose}){
  const platforms=[
    ...
    {svg:<svg xmlns="http://www.w3.org/2000/svg" width="40" height="46" viewBox="0 0 23 28"><path fill="white" d="M22.728 19.289c-.404 1.12-.887 2.157-1.45 3.112-.763 1.37-1.387 2.32-1.868 2.848-.745.816-1.543 1.234-2.397 1.254-.614 0-1.354-.175-2.215-.53-.864-.352-1.659-.528-2.385-.528-.763 0-1.58.176-2.452.529-.874.352-1.578.536-2.116.553-.82.034-1.636-.393-2.451-1.278-.52-.57-1.17-1.548-1.952-2.934-.837-1.481-1.526-3.197-2.066-5.151C.787 15.032.5 13.046.5 11.12c0-2.216.479-4.127 1.437-5.727a8.437 8.437 0 0 1 3.003-3.039 8.085 8.085 0 0 1 4.073-1.102c.799 0 1.847.247 3.147.734 1.297.487 2.131.734 2.5.734.274 0 1.203-.29 2.777-.867 1.488-.534 2.745-.756 3.774-.669 2.789.226 4.885 1.328 6.277 3.313-2.493 1.51-3.726 3.627-3.702 6.344.022 2.116.79 3.876 2.3 5.275.684.65 1.447 1.153 2.292 1.51l-.65 1.404zM17.68 1.019c0 1.658-.606 3.207-1.814 4.643-1.458 1.703-3.222 2.688-5.134 2.534a5.15 5.15 0 0 1-.038-.628c0-1.59.693-3.291 1.923-4.685.614-.7 1.396-1.284 2.343-1.75.946-.46 1.842-.716 2.684-.763.024.216.036.432.036.649z"/></svg>,label:"macOS",sub:"macOS 12+ · Universal",btn:"Download .dmg"},
    {svg:<svg xmlns="http://www.w3.org/2000/svg" width="40" height="46" viewBox="0 0 100 116"><ellipse cx="50" cy="28" rx="28" ry="28" fill="white"/><ellipse cx="50" cy="28" rx="16" ry="19" fill="#0D0B1F"/><circle cx="38" cy="23" r="4.5" fill="white"/><circle cx="62" cy="23" r="4.5" fill="white"/><circle cx="38" cy="23" r="2" fill="#0D0B1F"/><circle cx="62" cy="23" r="2" fill="#0D0B1F"/><path d="M42 34 Q50 38 58 34" stroke="white" strokeWidth="2.5" fill="none" strokeLinecap="round"/><ellipse cx="50" cy="72" rx="36" ry="30" fill="white"/><ellipse cx="50" cy="74" rx="20" ry="20" fill="#0D0B1F"/><ellipse cx="22" cy="96" rx="14" ry="8" fill="white" transform="rotate(-20 22 96)"/><ellipse cx="78" cy="96" rx="14" ry="8" fill="white" transform="rotate(20 78 96)"/><ellipse cx="22" cy="106" rx="12" ry="5" fill="white" transform="rotate(-10 22 106)"/><ellipse cx="78" cy="106" rx="12" ry="5" fill="white" transform="rotate(10 78 106)"/></svg>,label:"Linux",sub:"Ubuntu / Debian · .deb",btn:"Download .deb"},
  ];
  return(
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
        ...
        <div style={{maxWidth:1100,margin:"0 auto",textAlign:"center"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:16}}>
            {[
              ...
              {svg:<svg xmlns="http://www.w3.org/2000/svg" width="40" height="46" viewBox="0 0 23 28"><path fill="currentColor" d="M22.728 19.289c-.404 1.12-.887 2.157-1.45 3.112-.763 1.37-1.387 2.32-1.868 2.848-.745.816-1.543 1.234-2.397 1.254-.614 0-1.354-.175-2.215-.53-.864-.352-1.659-.528-2.385-.528-.763 0-1.58.176-2.452.529-.874.352-1.578.536-2.116.553-.82.034-1.636-.393-2.451-1.278-.52-.57-1.17-1.548-1.952-2.934-.837-1.481-1.526-3.197-2.066-5.151C.787 15.032.5 13.046.5 11.12c0-2.216.479-4.127 1.437-5.727a8.437 8.437 0 0 1 3.003-3.039 8.085 8.085 0 0 1 4.073-1.102c.799 0 1.847.247 3.147.734 1.297.487 2.131.734 2.5.734.274 0 1.203-.29 2.777-.867 1.488-.534 2.745-.756 3.774-.669 2.789.226 4.885 1.328 6.277 3.313-2.493 1.51-3.726 3.627-3.702 6.344.022 2.116.79 3.876 2.3 5.275.684.65 1.447 1.153 2.292 1.51l-.65 1.404zM17.68 1.019c0 1.658-.606 3.207-1.814 4.643-1.458 1.703-3.222 2.688-5.134 2.534a5.15 5.15 0 0 1-.038-.628c0-1.59.693-3.291 1.923-4.685.614-.7 1.396-1.284 2.343-1.75.946-.46 1.842-.716 2.684-.763.024.216.036.432.036.649z"/></svg>,label:"macOS",sub:"macOS 12+"},
              {svg:<svg xmlns="http://www.w3.org/2000/svg" width="40" height="46" viewBox="0 0 100 116"><ellipse cx="50" cy="28" rx="28" ry="28" fill="currentColor"/><ellipse cx="50" cy="28" rx="16" ry="19" fill="white"/><circle cx="38" cy="23" r="4.5" fill="currentColor"/><circle cx="62" cy="23" r="4.5" fill="currentColor"/><circle cx="38" cy="23" r="2" fill="white"/><circle cx="62" cy="23" r="2" fill="white"/><path d="M42 34 Q50 38 58 34" stroke="currentColor" strokeWidth="2.5" fill="none" strokeLinecap="round"/><ellipse cx="50" cy="72" rx="36" ry="30" fill="currentColor"/><ellipse cx="50" cy="74" rx="20" ry="20" fill="white"/><ellipse cx="22" cy="96" rx="14" ry="8" fill="currentColor" transform="rotate(-20 22 96)"/><ellipse cx="78" cy="96" rx="14" ry="8" fill="currentColor" transform="rotate(20 78 96)"/><ellipse cx="22" cy="106" rx="12" ry="5" fill="currentColor" transform="rotate(-10 22 106)"/><ellipse cx="78" cy="106" rx="12" ry="5" fill="currentColor" transform="rotate(10 78 106)"/></svg>,label:"Linux",sub:"Ubuntu / Debian"}
            ].map(p=>(
        ...
        <div style={{maxWidth:1100,margin:"0 auto"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:1,background:"#2D2D2D"}}>
            {[
              ...
              {svg:<svg xmlns="http://www.w3.org/2000/svg" width="40" height="46" viewBox="0 0 23 28"><path fill="white" d="M22.728 19.289c-.404 1.12-.887 2.157-1.45 3.112-.763 1.37-1.387 2.32-1.868 2.848-.745.816-1.543 1.234-2.397 1.254-.614 0-1.354-.175-2.215-.53-.864-.352-1.659-.528-2.385-.528-.763 0-1.58.176-2.452.529-.874.352-1.578.536-2.116.553-.82.034-1.636-.393-2.451-1.278-.52-.57-1.17-1.548-1.952-2.934-.837-1.481-1.526-3.197-2.066-5.151C.787 15.032.5 13.046.5 11.12c0-2.216.479-4.127 1.437-5.727a8.437 8.437 0 0 1 3.003-3.039 8.085 8.085 0 0 1 4.073-1.102c.799 0 1.847.247 3.147.734 1.297.487 2.131.734 2.5.734.274 0 1.203-.29 2.777-.867 1.488-.534 2.745-.756 3.774-.669 2.789.226 4.885 1.328 6.277 3.313-2.493 1.51-3.726 3.627-3.702 6.344.022 2.116.79 3.876 2.3 5.275.684.65 1.447 1.153 2.292 1.51l-.65 1.404zM17.68 1.019c0 1.658-.606 3.207-1.814 4.643-1.458 1.703-3.222 2.688-5.134 2.534a5.15 5.15 0 0 1-.038-.628c0-1.59.693-3.291 1.923-4.685.614-.7 1.396-1.284 2.343-1.75.946-.46 1.842-.716 2.684-.763.024.216.036.432.036.649z"/></svg>,label:"macOS",sub:"macOS 12+",ver:"v2.4.1"},
              {svg:<svg xmlns="http://www.w3.org/2000/svg" width="40" height="46" viewBox="0 0 100 116"><ellipse cx="50" cy="28" rx="28" ry="28" fill="white"/><ellipse cx="50" cy="28" rx="16" ry="19" fill="#1A1A1A"/><circle cx="38" cy="23" r="4.5" fill="white"/><circle cx="62" cy="23" r="4.5" fill="white"/><circle cx="38" cy="23" r="2" fill="#1A1A1A"/><circle cx="62" cy="23" r="2" fill="#1A1A1A"/><path d="M42 34 Q50 38 58 34" stroke="white" strokeWidth="2.5" fill="none" strokeLinecap="round"/><ellipse cx="50" cy="72" rx="36" ry="30" fill="white"/><ellipse cx="50" cy="74" rx="20" ry="20" fill="#1A1A1A"/><ellipse cx="22" cy="96" rx="14" ry="8" fill="white" transform="rotate(-20 22 96)"/><ellipse cx="78" cy="96" rx="14" ry="8" fill="white" transform="rotate(20 78 96)"/><ellipse cx="22" cy="106" rx="12" ry="5" fill="white" transform="rotate(-10 22 106)"/><ellipse cx="78" cy="106" rx="12" ry="5" fill="white" transform="rotate(10 78 106)"/></svg>,label:"Linux",sub:"Ubuntu / Debian",ver:"v2.4.1"}
            ].map(p=>(
