# Historical Design Brief (Not a Release Status)

This document predates the parallel ecosystem implementation. Its availability,
security, compliance, demo-account and deployment claims are not verified.
Do not use its credentials or commands. See ../ECOSYSTEM_STATUS.md instead.
