...
The `archive/` directory preserves earlier proposals. They are not the current
API contract, verified security evidence, or a statement of release availability.
